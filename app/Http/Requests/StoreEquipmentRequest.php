    ...
    public function rules(): array
    {
        return [
            'item_code' => [
                ...
                'string',
                'max:50',
                Rule::unique('equipment', 'item_code')->ignore($this->route('equipment')?->id),
            ],
            'item_name' => ['required', 'string', 'max:255'],
            'category' => ['required', 'string', Rule::in(Equipment::CATEGORIES)],
            ...
            'condition' => ['required', 'string', Rule::in(Equipment::CONDITIONS)],
