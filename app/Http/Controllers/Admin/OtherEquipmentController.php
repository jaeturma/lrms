...
class OtherEquipmentController extends Controller
{
    public function index(Request $request): Response
    {
        ...
        $equipment = OtherEquipment::query()
            ...
            ->paginate(20)
            ->withQueryString()
            ->through(fn (OtherEquipment $item): array => [
                'id' => $item->id,
        ...
        return Inertia::render('AdminOtherEquipment', [
            'filters' => [
                'search' => $search,
            ...
            'equipment' => $equipment,
            'summary' => [
                'total' => OtherEquipment::count(),
                'by_status' => OtherEquipment::query()
