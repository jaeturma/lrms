...
class LearningResourceResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'date_delivered' => $this->date_delivered?->toDateString(),
            'ier_no' => $this->ier_no,
            'publisher' => $this->publisher,
            'cover_image_url' => $this->resourceTitle?->coverImageUrl(),
            'attachment_url' => $this->resourceTitle?->attachmentUrl(),
            'media_url' => $this->resourceTitle?->media_url,
