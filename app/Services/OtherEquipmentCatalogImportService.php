...
class OtherEquipmentCatalogImportService
{
    ...
    private function importRow(array $row): string
    {
        ...
        if (! in_array($category, OtherEquipment::CATEGORIES, true)) {
        ...
        $catalogItem = OtherEquipmentCatalogItem::query()
        ...
        OtherEquipmentCatalogItem::query()->create($attributes);
