...
class SmeCatalogImportService
{
    ...
    private function importRow(array $row): string
    {
        ...
        if (! in_array($category, Sme::CATEGORIES, true)) {
            throw new \RuntimeException('SME category is invalid.');
        }
        ...
        $catalogItem = SmeCatalogItem::query()
        ...
        SmeCatalogItem::query()->create($attributes);
