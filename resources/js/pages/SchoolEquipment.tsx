...
export default function SchoolEquipment({ equipment, movements, categories, conditions, statuses }: Props) {
    ...
    const submit = () => {
        ...
        if (editingId === null) {
            post('/school/equipment', options);
        } else {
            put(`/school/equipment/${editingId}`, options);
        }
    };
    ...
    const deleteEquipment = (item: EquipmentItem) => {
        ...
        router.delete(`/school/equipment/${item.id}`, { preserveScroll: true });
    };
            ...
            <div className="space-y-6 p-4 md:p-6">
                <section className="rounded-2xl border border-border bg-card p-5 shadow-sm">
                    <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
                        <div>
                            <h2 className="text-lg font-semibold text-foreground">Educational Equipment</h2>
                            <p className="text-sm text-muted-foreground">
                                Register and track equipment that supports teaching and learning. Status, condition,
            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-2xl">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Fields marked with * are required. Leave the item code blank to generate one automatically.
                        </DialogDescription>
                    </DialogHeader>
