    ...
    return (
        <>
            ...
            <main className="min-h-screen bg-slate-50 p-4 md:p-8">
                <div className="mx-auto max-w-4xl space-y-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                    <div className="flex items-center justify-between gap-3">
                        <div>
                            <h1 className="text-2xl font-bold text-slate-900">School CSV Import</h1>
                            <p className="text-sm text-slate-600">
                                Upload a CSV with district, municipality, barangay, school_id, school_name.
                            </p>
                        </div>
