...
export default function AdminEquipment({ filters, categories, statuses, equipment, summary }: Props) {
    return (
        <>
            ...
            <main className="min-h-screen bg-background/40 p-4 md:p-8">
                <div className="mx-auto max-w-7xl space-y-6">
                    <header className="rounded-2xl border border-border bg-card p-5 shadow-sm">
                        <h1 className="text-2xl font-bold text-foreground">Educational Equipment</h1>
                        <p className="text-sm text-muted-foreground">
                            Division-wide view of equipment registered by schools ({summary.total.toLocaleString()} items).
                        </p>
                    ...
                    <section className="rounded-2xl border border-border bg-card p-5 shadow-sm">
                        <form method="get" action="/app/admin/equipment" className="mb-4 flex flex-wrap gap-2">
                            <input
                                name="search"
